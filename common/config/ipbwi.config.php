...
if (!defined('ipbwi_BOARD_PATH')) {
    define('ipbwi_BOARD_PATH', \Yii::$app->params['ipbwi_BOARD_PATH']);
}
...
if (!defined('ipbwi_ROOT_PATH')) {
    define('ipbwi_ROOT_PATH', \Yii::$app->params['ipbwi_ROOT_PATH']);
}
...
if (!defined('ipbwi_WEB_URL')) {
    define('ipbwi_WEB_URL', \Yii::$app->params['ipbwi_WEB_URL']);
}
...
if (!defined('ipbwi_COOKIE_DOMAIN')) {
    define('ipbwi_COOKIE_DOMAIN', \Yii::$app->params['ipbwi_COOKIE_DOMAIN']);
}
