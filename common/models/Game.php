...
class Game extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['developer_id', 'desc', 'keywords', 'localizator', 'status', 'news_desc', 'info', 'specs', 'ozon', 'rate_pos', 'rate_neg', 'voted_users'], 'required'],
            ...
            [['url', 'title', 'release_date', 'platforms', 'publisher', 'localizator', 'logo', 'small_logo', 'status_old', 'tweettag'], 'string', 'max' => 255],
