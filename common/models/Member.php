...
/**
 * This is the model class for table "be_members".
 *
...
class Member extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['member_group_id', 'joined', 'posts', 'allow_admin_mails', 'skin', 'warn_level', 'warn_lastwarn', 'language', 'last_post', 'view_sigs', 'view_img', 'bday_day', 'bday_month', 'bday_year', 'msg_count_new', 'msg_count_total', 'msg_count_reset', 'msg_show_notification', 'last_visit', 'last_activity', 'dst_in_use', 'coppa_user', 'sub_end', 'member_login_key_expire', 'subs_pkg_chosen', 'has_blog', 'has_gallery', 'members_auto_dst', 'members_created_remote', 'members_disable_pm', 'failed_login_count', 'members_profile_views', 'forum_icons', 'reputation', 'member_banned', 'members_bitoptions', 'fb_uid', 'fb_lastsync', 'notification_cnt', 'tc_lastsync', 'vk_uid', 'use_sign'], 'integer'],
            [['ip_address'], 'required'],
            [['ignored_users', 'members_cache', 'failed_logins', 'identity_url', 'fb_token', 'vk_token'], 'string'],
            [['name', 'mgroup_others', 'org_perm_id', 'members_display_name', 'members_seo_name', 'members_l_display_name', 'members_l_username', 'twitter_id', 'twitter_token', 'twitter_secret', 'ban_reason'], 'string', 'max' => 255],
            ...
            [['member_login_key', 'members_pass_hash', 'member_uploader', 'members_day_posts', 'live_id'], 'string', 'max' => 32],
