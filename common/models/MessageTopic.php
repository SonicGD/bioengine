...
/**
 * This is the model class for table "be_message_topics".
 *
 ...
 */
class MessageTopic extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['mt_date', 'mt_hasattach', 'mt_starter_id', 'mt_start_time', 'mt_last_post_time', 'mt_to_count', 'mt_to_member_id', 'mt_replies', 'mt_last_msg_id', 'mt_first_msg_id', 'mt_is_draft', 'mt_is_deleted', 'mt_is_system'], 'integer'],
