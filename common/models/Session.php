...
/**
 * This is the model class for table "be_sessions".
 *
 * @property string $id
...
class Session extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['member_id', 'running_time', 'login_type', 'member_group', 'in_error', 'location_1_id', 'location_2_id', 'location_3_id', 'uagent_bypass', 'search_thread_id', 'search_thread_time', 'session_msg_id'], 'integer'],
            [['id'], 'string', 'max' => 60],
            [['member_name', 'seo_name', 'location_1_type', 'location_2_type', 'location_3_type'], 'string', 'max' => 255],
