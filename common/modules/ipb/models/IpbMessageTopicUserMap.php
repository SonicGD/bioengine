 ...
 */
class IpbMessageTopicUserMap extends BioActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [
                ['map_user_id', 'map_topic_id'],
                'unique',
                'targetAttribute' => ['map_user_id', 'map_topic_id'],
                'message'         => 'The combination of Map User ID and Map Topic ID has already been taken.'
            ]
        ];
    }
